...
export const models: ModelSpec[] = [
  ...
  },
  {
    ...
    notes: [
      ...
      'A16: the DMPX-070 G-force figure is FROZEN and parked. No G-force is published for this frame.',
  ...
  },
  {
    ...
    notes: [
      ...
      'UNRESOLVED, needs a ruling: the DMPX-028 case study at /waste-oil-centrifuge-case-study-marine-and-industrial-waste-oil-recovery/ gives the bowl speed as 8,000 RPM while this model page says 6,325 RPM. No ruling covers it, so neither was changed.',
    ],
    rejectedValues: [
  ...
  /* ================================================== disc-stack: MAB frame */
  {
    ...
    notes: [
      ...
      'UNRESOLVED, needs a ruling: /smallest-industrial-centrifuges/ prose says 9,300 RPM while its own spec table says 9,375 RPM. The table value is carried here pending a ruling.',
    ],
    rejectedValues: [
  ...
  /* ======================================================== decanters: NX/UVNX */
  {
    ...
    notes: [
      ...
      'UNRESOLVED, needs a ruling: the comparison table on /wastewater-centrifuge/ gives the NX 314 a rated capacity of 80 GPM and the NX 418 170 GPM, against 25 GPM and 110 GPM on their own model pages. The duty rows below it (40 GPM at 5% sludge, 25 GPM at 10% sludge) are fluid-labelled and therefore inside A6, so nothing was changed except the motor rows, which A9 and E12 rule flatly.',
    ],
    rejectedValues: [
  ...
  },
  {
    ...
    tbd: true,
    notes: [
      'PARKED: motor HP is unresolved. The page table says 15 HP and its prose said 20 HP. Neither is ruled, so no HP is asserted and the table value is left as shipped until Sanjay rules.',
      'The 14" (353 mm) bowl diameter may itself be cloned from the NX 314 and is flagged for the same ruling.',
    ],
    skipPageAssert: ['hp'],
  },
  {
  ...
  },
  {
    ...
    conveyorProtection: CARBIDE,
    notes: [
      'The 3,150 RCF and AE 1,565 figures match the pre-correction NX 418 values and have never been ruled. Flagged for a future ruling; left as shipped because no ruling covers the G2-40.',
    ],
  },
  ...
  },
  {
    ...
    notes: [
      ...
      'UNRESOLVED, needs a ruling: /smallest-industrial-centrifuges/ prose says 3,070 Gs while its own spec table says 3,050 Gs. The table value is carried here pending a ruling.',
    ],
    rejectedValues: [
  ...
  },
  {
    ...
    notes: [
      ...
      'A16: 72 GPM actual on diesel and 95-108 GPM rated, both labelled. The G-FORCE FIGURE IS FROZEN AND PARKED - none is published for this module.',
